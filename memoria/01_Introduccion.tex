...
\textbf{isótopo \enquote{sucio}}, ya que ya que su desintegración conlleva la emisión simultánea de una cascada de rayos gamma de alta
...
\end{itemize}
% esto lo hice previo a desarrollar el algoritmo de separación de isótopos, realmente
...
reconstrucción y sustraer la imagen ($A+B - F*B'$). %esto es un borrador, hay que cambiarlo y pulirlo
...
\url{https://github.com/gutierrels/dirtyIsotopes/}. Más iformación en el Anejo \ref{anx:repo}.
