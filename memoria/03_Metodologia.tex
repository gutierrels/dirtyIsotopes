...
% 	\centering
% 	\vspace{-20pt}
% 	\includegraphics[width=\linewidth]{si78--357.png}
% 	\caption{Imagen comercial del escáner preclínico Bruker PET/CT Si78.}
% 	\label{fig:bruker_petct_si78}
% 	\vspace{-10pt}
% \end{wrapfigure}

El sistema de detección simulado se basa en las especificaciones técnicas del escáner preclínico comercial \textbf{Bruker PET/CT Si78}. La geometría se ha definido en \texttt{penRed} utilizando el módulo de geometría constructiva de cuádricas (\texttt{PEN\_QUADRIC}).

El modelo virtual consta de un anillo de detectores con las siguientes características:
