...
En el Anejo \ref{anx:codigo} se incluyen fragmentos de código (\textit{snippets}) y se detalla con mayor profundidad el funcionamiento técnico de estos algoritmos.
